...
| Tank | Factory + Tech Lab | 20 (mobile) / 45 (siège, AOE r=30 px) | ~0,85 s (mobile) / 1,8 s (siège) | 55 (mobile) / 120 (siège) | Non | 220 | **Mode siège** : dégâts en zone, portée étendue ; ne bat pas en retraite sous PV critiques |
...
| Barracks | BAR | 150 | — | 200 | Produit des Marines (sans module) ou des Marauders (Tech Lab) ; Réacteur : 2 Marines par cycle ; accepte un module (Tech Lab ou Réacteur) |
| Factory | FAC | 150 | 75 | 250 | Produit les Hélions (sans module) ou les Tanks (Tech Lab) ; accepte un module (Tech Lab ou Réacteur) |
...
| Module | Effet |
|---|---|
| Tech Lab | Débloque la production de Tanks (remplace les Hélions) |
| Réacteur | Permet la production de 2 Hélions simultanément par cycle (si les ressources le permettent) |
